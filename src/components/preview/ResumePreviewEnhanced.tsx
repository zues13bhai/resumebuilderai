...
import { exportToPDF, printResume } from '../../utils/exportUtils';
import { copyShareableLink, shareViaWebAPI } from '../../utils/shareUtils';

interface ResumePreviewEnhancedProps {
  resumeData: ResumeData;
  showActions?: boolean;
}

export const ResumePreviewEnhanced = forwardRef<HTMLDivElement, ResumePreviewEnhancedProps>(
  ({ resumeData, showActions = true }, ref) => {
    ...
    const handleShare = async () => {
      const webShareSuccess = await shareViaWebAPI(resumeData);
      if (!webShareSuccess) {
        await copyShareableLink(resumeData);
      }
    };
    ...
    return (
      <div className="bg-white shadow-2xl rounded-lg overflow-hidden">
        ...
        <div 
          ref={ref}
          data-resume-preview
          className="h-full overflow-auto p-8 text-sm leading-relaxed bg-white"
...
ResumePreviewEnhanced.displayName = 'ResumePreviewEnhanced';
